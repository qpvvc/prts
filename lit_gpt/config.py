...
pythia = [
    ...
    dict(
        org="EleutherAI", name="pythia-160m_2_310m", block_size=2048, n_layer=24, n_embd=768, n_head=12, padding_multiple=128
    ),
...
tiny_LLaMA = [
    ...
    dict(
        ...
        name="24L2048H",
        block_size=2048,
        vocab_size=32000, #cdj 128256 num_embeddings
        padding_multiple=64,
        n_layer=24,
        n_head=32,
        n_embd=2048, # embedding_dim
        rotary_percentage=1.0,
        parallel_residual=False,
        bias=False,
        _norm_class="FusedRMSNorm",
    ...
    dict(
        org="HKGAI",
        name="tiny_LLaMA_400M_like1.1B_width_v1",
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=24,
    ...
    dict(
        org="HKGAI",
        name="tiny_LLaMA_400M_like1.1B_width",
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=24,
    ...
    dict(
        org="HKGAI",
        name="tiny_LLaMA_400M_like1.1B_width_target",
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=24,
    ...
    dict(
        org="HKGAI",
        name="tiny_LLaMA_1.1B_64h_wo_gqa",
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=24,
